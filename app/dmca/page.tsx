        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-[#121212]/50">Digital Millennium Copyright Act Policy</p>
            </div>
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="bg-zinc-900/50 border border-zinc-700 rounded-lg p-6 mt-4">
                <p className="text-[#121212]/70"><strong>Email:</strong> dmca@nightstudio.com</p>
                <p className="text-[#121212]/70 mt-2"><strong>Address:</strong></p>
                <p className="text-[#121212]/70">NightStudio DMCA Agent<br/>
