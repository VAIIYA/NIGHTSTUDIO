            ...
            <section>
              ...
              <div className="space-y-4 mt-6">
                <div>
                  ...
                  <p className="text-zinc-300"><strong>Creators and Content Collaborators:</strong></p>
                ...
                <div>
                  <p className="text-zinc-300 mt-4"><strong>Fans:</strong></p>
                  <ul className="list-disc list-inside text-zinc-300 space-y-1 mt-2">
                    <li>email address</li>
                    <li>telephone number</li>
                  </ul>
                ...
                <div>
                  ...
                  <p className="text-zinc-300">Profile information, posts, comments, chat messages, and customer support queries.</p>
                </div>

                <div>
                  <h3 className="text-xl font-semibold mb-2">Financial Data</h3>
                  <p className="text-zinc-300">Payment card details (tokenized), billing address, wallet information, and transaction data.</p>
                </div>

                <div>
                  <h3 className="text-xl font-semibold mb-2">Technical Data</h3>
                  <p className="text-zinc-300">IP address, user agent, and other network activity information.</p>
                </div>

                <div>
                  <h3 className="text-xl font-semibold mb-2">Usage Data</h3>
                  <p className="text-zinc-300">Information collected through cookies and similar technologies.</p>
                </div>
              </div>
            </section>
